...
* p-destroy-vlan.yml
* p-ensure-public-ip.yml

Then:

* delete environment network
...
delete_network_prep = []
delete_network_prep.append(slowly_reverse_string.s("lmy.nalv-yortsed-p"))
delete_network_prep.append(slowly_reverse_string.s("lmy.pi-cilbup-erusne-p"))
...
delete_environment_prep.append(slowly_reverse_string.s("lmy.ehcac-edon-yortsed-e"))
