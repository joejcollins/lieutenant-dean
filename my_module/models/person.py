...
from clothing import Trousers, Hat
import json
import os
...
class Person(Model):
    ...
    def find_by_file(person_file_name):
        ...
        with open('./module/db/data/' + person_file_name) as json_file:
    ...
    def all():
        ...
        people = []
        for file in os.listdir('./module/db/data/'):
            if file.endswith(".json"):
                with open('./module/db/data/' + file) as json_file:
                    person_json = json.load(json_file)
    ...
    def save(self):
        ...
        with open('./module/db/data/' + self._person_file_name, 'w') as outfile:
